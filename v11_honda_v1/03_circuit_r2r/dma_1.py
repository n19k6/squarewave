...
for i in range(240):
    if i % 4 == 0:
        data[i] = 0b01000000_01000000_00100000_00010000
    if i % 4 == 1:
        data[i] = 0b00001000_00000100_00000010_00000001
    if i % 4 == 2:
        data[i] = 0b00000001_00000010_00000100_00001000
    if i % 4 == 3:
        data[i] = 0b00010000_00100000_01000000_01000000
