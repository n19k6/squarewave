 ...
 * d) steuerung der umdrehungen der kurbelwelle via poti 1. 6000 Umdrehungen können wegen geringem 
 * CPU takt von 8 MHz wahrscheinlich nicht erreicht werden
 * 
...
ISR(TIMER0_COMPA_vect)        
{
  ...
  */
  ...
  if (timer0_count % 2 == 0 && timer0_count != 8) {
